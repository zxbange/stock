...
.sidebar{{width:85px;background:#1a1a2e;border-right:1px solid #2a2a3e;overflow-y:auto;flex-shrink:0;transition:width .25s}}.sidebar.collapsed{{width:0;overflow:hidden}}
...
.topbar{{background:#1a1a2e;border-bottom:1px solid #2a2a3e;padding:8px 8px;display:flex;align-items:center;gap:8px;flex-shrink:0;height:48px}}
...
html += """  </div>
  ...
  <div class="main">
    <div class="topbar">
      <span id="sidebar-arrow" onclick="toggleSidebar()" style="cursor:pointer;font-size:12px;color:#888;margin-right:10px;flex-shrink:0" title="展开/收起侧栏">&#x25C0;</span>
      <div>
